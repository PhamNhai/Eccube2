<?php /* Smarty version 2.6.26, created on 2018-10-24 15:33:52
         compiled from C:%5Cxampp%5Chtdocs%5Ceccube2%5Chtml/../data/Smarty/templates/admin/contents/subnavi.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'C:\\xampp\\htdocs\\eccube2\\html/../data/Smarty/templates/admin/contents/subnavi.tpl', 3, false),)), $this); ?>
...
<?php echo ((is_array($_tmp=@ADMIN_DIR)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
contents/file_manager.php"><span>ファイル管理</span></a></li><li<?php if (((is_array($_tmp=$this->_tpl_vars['tpl_subno'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 'recommend-banner'): ?> class="on"<?php endif; ?> id="navi-contents-recommend-banner"><a href="<?php echo ((is_array($_tmp=@ROOT_URLPATH)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
<?php echo ((is_array($_tmp=@ADMIN_DIR)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
contents/plg_Recommend_recommend.php"><span>レコメンドバナー管理</span></a></li>
