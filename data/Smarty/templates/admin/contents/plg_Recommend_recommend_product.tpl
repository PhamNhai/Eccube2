...
<script type="text/javascript">//<![CDATA[
    ...
    function func_submit(product_id, class_name1, class_name2,product_name) {
        var err_text = '';
        ...
        var opner_product_id = 'product_id';
        var opner_product_class_id = 'product_class_id';
        var tpl_no = '<!--{$tpl_no}-->';
        ...
        fm1.getElementById("product_name").innerHTML = "商品ID:"+product_id + "<br>商品名：" + product_name;
        ...
        <!--{section name=cnt loop=$arrProducts}-->
            ...
            <form name="product_form<!--{$id|h}-->" action="?" onsubmit="return false;">
                ...
                <tr style="background:<!--{$arrPRODUCTSTATUS_COLOR[$status]}-->;">
                    ...
                    <td class="center"><a href="javascript:;" onclick="return func_submit('<!--{$arrProducts[cnt].product_id}-->', '<!--{$tpl_class_name1[$id]}-->', '<!--{$tpl_class_name2[$id]}-->','<!--{$arrProducts[cnt].name|h}-->'); return false;">決定</a></td>
                </tr>
                <!--▲商品<!--{$smarty.section.cnt.iteration}-->-->
            </form>
        <!--{sectionelse}-->
