...
/**
 * レコメンドバナー管理_商品選択画面 のページクラス.
 *
 * @package Page
 * @author SEED
 * @version $Id: plg_Recommend_LC_Page_Admin_Contents_Recommend_Product.php 21232 2011-09-04 15:44:01Z Seasoft $
 */
class plg_Recommend_LC_Page_Admin_Contents_Recommend_Product extends LC_Page_Admin_Ex {
    ...
    function init() {
        ...
        $this->tpl_mainpage = 'contents/plg_Recommend_recommend_product.tpl';
